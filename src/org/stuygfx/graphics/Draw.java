...
public class Draw {
    ...
    public static void drawLine(Image pic, Pixel color, Point p1, Point p2) {
        int octant = get_octant(p1, p2);

        // We can "shift" p1 to (0, 0), and plot with an offset
        Point p1_converted = new Point(0, 0);
        Point p2_converted = convert_to_octant_1(new Point(p2.x - p1.x, p2.y - p1.y), octant);
